   ...
   <form class="mt-5"  method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">    
     <div class="form-group row">
            ...
            <div class="col-8">
                <input class="form-control" name="cat_name" type="text"  id="example-text-input" placeholder="category name">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-2">
                <input  type="submit" name="add_category" value="add category" class="form-control btn btn-primary text-light">
            </div>
        </div>
   </form>
