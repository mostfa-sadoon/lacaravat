        ...
        <div class="card">
            ...
            <div class="card-body">
               ...
               <span>quantity: <span class="label label-info label-rounded"><?php echo $quantity; ?></span></span>
                <p class="m-b-0 m-t-20"><?php echo  substr($description,0,40);?></p>
                <div class="d-flex m-t-20">
                    <button class="btn p-l-0 btn-link ">Read more</button>
                    <div class="ml-auto align-self-center">
                    <a href="<?php echo "product.php?page_title=edit_product&id=".$id."&redirect=main_product"; ?>" class="btn btn-success text-light"> <i class="fas fa-edit"></i> </a>
