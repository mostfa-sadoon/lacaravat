...
<head>
    ...
    <link href="dashboard/assets/plugins/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="dashboard/assets/css/style.css" rel="stylesheet">
    <!-- Dashboard 1 Page CSS -->
    <link href="dashboard/assets/css/pages/dashboard1.css" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="dashboard/assets/css/colors/default-dark.css" id="theme" rel="stylesheet">
