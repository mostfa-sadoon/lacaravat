...
<!-- ***** Main Banner Area Start ***** -->
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                ...
                <h2>Best <em>Clothes store</em> in town</h2>
    ...
    <section class="section" id="trainers">
        <div class="container">
            ...
            <div class="main-button text-center">
                <a href="<?php echo"products.php" ?>">View our products</a>
            </div>
        </div>
    </section>
    <!-- ***** Cars Ends ***** -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="cta-content text-center">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto nulla quo cum officia laboriosam. Amet tempore, aliquid quia eius commodi, doloremque omnis delectus laudantium dolor reiciendis non nulla! Doloremque maxime quo eum
                            in culpa mollitia similique eius doloribus voluptatem facilis! Voluptatibus, eligendi, illum. Distinctio, non!</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        ...
                        <div class="main-button">
                            <a href="<?php echo"contact.php" ?>">Contact us</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section" id="features">
        <div class="container">
            ...
            <div class="main-button text-center">
                <a href="<?php echo"products.php" ?>">Read More</a>
            </div>
        </div>
    </section>
